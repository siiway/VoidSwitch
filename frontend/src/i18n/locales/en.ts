const en = {
  ...
  settings: {
    ...
    upstreamSelectMode: "Upstream selection mode",
    upstreamRankAlgorithm: "Upstream ranking algorithm",
    upstreamRankAlpha: "Upstream rank α (failure-rate weight)",
    upstreamRankBeta: "Upstream rank β (latency weight)",
    upstreamRankGamma: "Upstream rank γ (consecutive-failure weight)",
    upstreamBalanceTolerance: "Balanced selection score tolerance",
    upstreamPinJitter: "Pinned selection jitter",
    upstreamEwmaHalfLife: "Upstream EWMA half-life (s)",
    upstreamMinSamples: "Minimum samples before health ranking",
    upstreamTierHealthyThreshold: "Healthy-tier success-rate threshold",
    upstreamMaxKeysPerAttempt: "Maximum keys tried per upstream",
    upstreamCooldownStatusCodes: "Upstream cooldown status codes (comma-separated; 0 = network error)",
    upstreamCooldownSeconds: "Base upstream cooldown (s)",
    upstreamCooldownBackoffCap: "Upstream cooldown backoff cap",
    upstreamRetryAfterHeaders: "Retry-after headers (one per line)",
    upstreamAllCooledBehavior: "Behavior when all upstreams are cooled",
